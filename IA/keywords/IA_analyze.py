...
from IA.keywords.analyze.analyze_batches import process_batches
from IA.keywords.frames.extract_frames import compute_phash_from_frame, extract_segment_frames
from IA.keywords.frames.frames_hash import SegmentFrameHash
from IA.keywords.ia_models import AIContext
from IA.keywords.prep.prep_analyze import cleanup_temp, open_vid, release_cap
from IA.keywords.utils.ai_result import AIOutputType, AIResult
...
def run_prompt_on_batches(
    *,
    ...
    for b in range(num_batches):
        ...
        release_gpu_memory(logger=logger)
        free, total = vram_gpu()
