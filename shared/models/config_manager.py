...
class ConfigManager:
    ...
    def _reload_all(self, logger: LoggerProtocol | None = None) -> None:
        ...
        self.enhancer_router: YamlDict = self._load_yaml("enhancer_router.yaml", logger=logger)
    ...
    def _ensure_defaults(self, logger: LoggerProtocol | None = None) -> None:
        logger = ensure_logger(logger, __name__)
        for section in ("smartcut", "comfyui_router", "enhancer_router", "cutmindpaths", "keywords"):
